                                ...
                                $.ajax({
                                    ...
                                    $.each(data, function (key, data) {
                                        ...
                                        if (tipoPergunta == 1 || tipoPergunta == 2) {
                                            ...
                                            respostas += '<input type="radio" class="checkbox' + p + '" id="' + data.id_resposta + '" name="' + data.id_resposta + '" id="labelRes' + p + '" value="' + data.resposta + '"><span class="input-group-addon" id="labelRes' + p + '">' + data.resposta + '</span>'
