                            ...
                            $.each(data, function (key, data) {
                                ...
                                $.ajax({
                                    ...
                                    $.each(data, function (key, data) {
                                       ...
                                       respostas += '<div class="col-sm-6"><center><div id="div_resp"><label class="input-group input-group-radio row"><input type="radio" class="hidden-inputs" name="optradio" value="' + data.resposta + '"><span class="input-group-addon"></span><span class="input-group-title" id="resp" >'+  data.resposta+'</span></label></center></div></div>'
